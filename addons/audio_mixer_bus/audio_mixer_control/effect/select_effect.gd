...
var fx_path = "res://addons/audio_mixer_bus/audio_mixer_control/effects/"
...
func add_effect(effect_index):
	...
	var control_fx = load("res://addons/audio_mixer_bus/audio_mixer_control/effect/effect_control.tscn").instantiate()
	control_fx.bus = bus
